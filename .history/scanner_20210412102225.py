...
async def on_ready():
    ...
    for channelID in channelIDs:
        ...
        if type(channel) == discord.channel.TextChannel:
            ...
            if not os.path.exists('channeltranscripts/{}'.format(category.name)):
                os.mkdir('channeltranscripts/{}'.format(category.name))
            data.to_csv('channeltranscripts/{}/{}.csv'.format(category.name, channel.name))
